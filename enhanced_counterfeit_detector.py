...
class EnhancedLogoDetector:
    ...
    def __init__(self, model_path: str = "./my_model/my_model.pt"):
        self.device = "cuda" if torch.cuda.is_available() else "cpu"
...
class LogoComparator:
    ...
    def _calculate_logo_similarity(self, logo1: LogoInfo, logo2: LogoInfo) -> float:
        ...
        try:
            ...
            similarity = cosine_similarity([logo1.features], [logo2.features])[0][0]
...
class EnhancedCounterfeitDetector:
    ...
    def __init__(self, yolo_model_path: str = "./my_model/my_model.pt"):
    ...
    def visualize_analysis(self, image: np.ndarray, result: CounterfeitAnalysisResult, save_path: str = None):
...
async def analyze_product_image(image_path: str, description: str = "", output_dir: str = "output"):
    ...
    # Initialize detector
    detector = EnhancedCounterfeitDetector("./my_model/my_model.pt")
